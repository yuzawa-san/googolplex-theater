...
public final class GoogolplexTheater {
	...
	public static void main(String[] args) throws InterruptedException {
		try {
			...
			GoogolplexController controller = new GoogolplexControllerImpl(vertx.nettyEventLoopGroup(),
					config.getAppId());
			...
			ServiceDiscovery serviceDiscovery = new ServiceDiscovery(controller, config.getInterfaceAddress());
